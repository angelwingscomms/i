...
test.describe('Room Search', () => {
    ...
    test.beforeAll(async () => {
        // Create a dummy room
        roomId = await create({ s: 'r', t: 'Test Room Search', d: 'A room for testing search' }, 'Test Room Search');
        // Create a dummy user
        userId = await create({ s: 'u', t: 'Test User Search', d: 'A user for testing search' }, 'Test User Search');
    });
