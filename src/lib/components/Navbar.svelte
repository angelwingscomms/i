		...
		<div class="flex h-16 items-center justify-between">
			...
			<div class="hidden items-center gap-6 md:flex">
				{#if can_install && !is_installed}
					<button class="rounded-full px-4 py-2 text-sm font-semibold text-white transition-all hover:scale-105" style="background: var(--color-theme-1);" onclick={do_install} transition:fade>
						Install App
					</button>
				{/if}
				...
				<div class="flex items-center gap-4">
					<a href="/i" class="nav-link group flex items-center gap-2 rounded-full px-3 py-2 text-sm font-medium transition-all hover:scale-105" style="color: var(--color-theme-1); border: 1px solid var(--color-theme-1);">
					...
					<a href="/u" class="nav-link group flex items-center gap-2 rounded-full px-3 py-2 text-sm font-medium transition-all hover:scale-105" style="color: var(--color-theme-2); border: 1px solid var(--color-theme-2);">
						<svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
							<path d="M12,4A4,4 0 0,1 16,8A4,4 0 0,1 12,12A4,4 0 0,1 8,8A4,4 0 0,1 12,4M12,14C16.42,14 20,15.79 20,18V20H4V18C4,15.79 7.58,14 12,14Z"/>
						</svg>
						Users
					</a>
					<a href="/r" class="nav-link group flex items-center gap-2 rounded-full px-3 py-2 text-sm font-medium transition-all hover:scale-105" style="color: var(--color-theme-3); border: 1px solid var(--color-theme-3);">
						<svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
				...
				{#if user}
					<div class="flex items-center gap-4">
						<a href="/edit_user" class="nav-link group flex items-center gap-2 rounded-full px-3 py-2 text-sm font-medium transition-all hover:scale-105" style="color: var(--color-theme-6); border: 1px solid var(--color-theme-6);">
							<svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
						...
						<div class="flex items-center gap-3 pl-4" style="border-left: 2px solid var(--color-theme-6);">
							<a href="/u/{user.i}" class="text-sm font-bold transition-all hover:scale-105" style="color: var(--color-theme-4);">{user.t}</a>
							<a href="/logout" class="group flex items-center gap-2 rounded-full px-3 py-2 text-sm font-medium transition-all hover:scale-105" style="color: var(--color-theme-5); border: 1px solid var(--color-theme-5);">
								<svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
				...
				{:else}
					<a href="/google" class="group flex items-center gap-3 rounded-full px-6 py-3 font-bold text-white shadow-lg transition-all hover:scale-105" style="background: var(--color-theme-2);">
						<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
							<path d="M21.35,11.1H12.18V14.89H17.48C17.18,16.89 15.19,18.15 12.18,18.15C9.57,18.15 7.39,15.93 7.39,13.11C7.39,10.29 9.57,8.07 12.18,8.07C13.68,8.07 14.65,8.62 15.32,9.27L18.04,6.64C16.4,5.08 14.07,4 12.18,4C7.4,4 3.53,7.87 3.53,13.11C3.53,18.35 7.4,22.22 12.18,22.22C16.8,22.22 20.25,18.06 20.25,13.11C20.25,12.44 20.19,11.75 20.08,11.1H21.35V11.1Z"/>
						</svg>
						Sign In with Google
					</a>
				{/if}
