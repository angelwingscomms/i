...
const MIME_TYPE_MAP: Record<string, FileInfo> = {
	// Images
	'image/jpeg': { type: 'image', icon: 'fa-file-image', mimeType: 'image/jpeg', extension: 'jpg' },
	'image/jpg': { type: 'image', icon: 'fa-file-image', mimeType: 'image/jpg', extension: 'jpg' },
	...
	'audio/mp3': { type: 'audio', icon: 'fa-file-audio', mimeType: 'audio/mp3', extension: 'mp3' },
	'audio/wav': { type: 'audio', icon: 'fa-file-audio', mimeType: 'audio/wav', extension: 'wav' },
	'audio/ogg': { type: 'audio', icon: 'fa-file-audio', mimeType: 'audio/ogg', extension: 'ogg' },
	'audio/aac': { type: 'audio', icon: 'fa-file-audio', mimeType: 'audio/aac', extension: 'aac' },
	'audio/flac': { type: 'audio', icon: 'fa-file-audio', mimeType: 'audio/flac', extension: 'flac' },

	// Video
	'video/mp4': { type: 'video', icon: 'fa-file-video', mimeType: 'video/mp4', extension: 'mp4' },
	'video/avi': { type: 'video', icon: 'fa-file-video', mimeType: 'video/avi', extension: 'avi' },
	'video/mov': { type: 'video', icon: 'fa-file-video', mimeType: 'video/mov', extension: 'mov' },
	'video/wmv': { type: 'video', icon: 'fa-file-video', mimeType: 'video/wmv', extension: 'wmv' },
 ...
 */
export function getFileInfo(urlOrFilename: string, mimeType?: string): FileInfo {
	...
	const extension = getFileExtension(urlOrFilename).toLowerCase();
 ...
 */
export function isImage(urlOrFilename: string, mimeType?: string): boolean {
	return getFileInfo(urlOrFilename, mimeType).type === 'image';
}

/**
 * Check if file is audio
 */
export function isAudio(urlOrFilename: string, mimeType?: string): boolean {
	return getFileInfo(urlOrFilename, mimeType).type === 'audio';
}

/**
 * Check if file is video
 */
export function isVideo(urlOrFilename: string, mimeType?: string): boolean {
	return getFileInfo(urlOrFilename, mimeType).type === 'video';
}
