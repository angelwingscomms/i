...
const model_cache: Record<
	string,
	Promise<GraniteInstance> | GraniteInstance
> = {};
let transformer_module: Promise<
	typeof import('@huggingface/transformers')
> | null = null;

export const supports_webgpu = () =>
