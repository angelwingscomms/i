...
>
	<div class="mx-auto max-w-md p-8 text-center">
		<div class="mb-8">
			<svg width="64" height="64" viewBox="0 0 24 24" fill="none" class="mx-auto text-red-500">
				<path
		...
		{#if page.error?.stack}
			<details class="mt-6 text-left">
				...
				>
				<pre class="mt-2 max-h-32 overflow-auto rounded bg-gray-800 p-3 text-xs text-gray-300">{page
						.error.stack}</pre>
			</details>
		{/if}
	</div>
