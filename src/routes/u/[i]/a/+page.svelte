...
<div class="mx-auto max-w-2xl p-4">
	<div class="mb-6 flex items-center justify-between">
		<h1 class="text-2xl font-semibold" style="color: var(--color-theme-4);">
			anonymous chats with {page.data.t}
		</h1>
		<button
	...
	{:else}
		<div class="space-y-4">
			{#each page.data.c as chat}
				<a
					href="/r/{chat.i}"
					class="block rounded-lg border border-gray-200 p-4 transition-colors hover:border-gray-300"
				>
