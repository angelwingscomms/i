	...
	{#if user}
		...
		<section class="profile-hero relative overflow-hidden px-4 py-16 sm:px-2 sm:py-12">
			...
			<div class="relative mx-auto max-w-4xl text-center">
				...
				<div class="profile-info space-y-4">
					<h1 class="text-5xl font-bold sm:text-3xl" style="color: var(--color-theme-4);">
						{user.tag}
					</h1>
		...
		<section class="mx-auto max-w-6xl px-4 py-16 sm:px-2 sm:py-8">
			<div class="mb-12 text-center">
				<h2 class="mb-4 text-4xl font-bold" style="color: var(--color-theme-4);">
					Explore Our Platform
				</h2>
				<p class="text-xl" style="color: var(--color-theme-6);">
					Discover amazing features and connect with your community
				</p>
			</div>
			...
			<div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
				...
				>
					...
					<h3 class="mb-3 text-center text-xl font-bold" style="color: var(--color-theme-4);">
						Products & Services
					</h3>
					<p class="mb-4 text-center" style="color: var(--color-theme-6);">
						Discover local businesses, handcrafted products, and professional services in your area.
					</p>
				...
				>
					...
					<p class="mb-4 text-center text-gray-600 dark:text-gray-300">
						Search for products and services near your location with smart filtering.
					</p>
					<div class="text-center">
						<a
				...
				>
					...
					<p class="mb-4 text-center text-gray-600 dark:text-gray-300">
						Join topic-based chatrooms and connect with like-minded people.
					</p>
					<div class="text-center">
						<a
							href="/r"
				...
				>
					...
					<p class="mb-4 text-center text-gray-600 dark:text-gray-300">
						Search for users with detailed descriptions and find people similar to yourself.
					</p>
					<div class="text-center">
						<a
							href="/u"
				...
				>
					...
					<p class="mb-4 text-center text-gray-600 dark:text-gray-300">
						Chat with AI about products, get recommendations, and smart assistance.
					</p>
					<div class="text-center">
						<a
							href="/i"
				...
				>
					...
					<p class="mb-4 text-center text-gray-600 dark:text-gray-300">
						Chat directly with product owners and service providers.
					</p>
					<div class="text-center">
						<a
							href="/u"
		...
		{#if user.socialLinks && user.socialLinks.length > 0}
			<section class="mx-auto max-w-6xl px-4 py-16 sm:px-2 sm:py-8">
				<div class="text-center">
					<h3 class="mb-8 text-3xl font-bold" style="color: var(--color-theme-4);">
