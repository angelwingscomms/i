		...
		<div class="mb-8 sm:p-6">
			...
			{#if data.user && !is_own_profile}
				<div class="mb-8 flex justify-center">
					<a
						href="/u/{user.i}/c"
						class="flex items-center gap-2 rounded-xl bg-blue-600 px-8 py-4 text-lg font-semibold text-white no-underline shadow-md transition-all hover:-translate-y-0.5 hover:bg-blue-700 hover:shadow-lg sm:px-6 sm:py-3.5 sm:text-base"
					>
