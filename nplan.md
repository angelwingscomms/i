...
export async function search_users_in_room(room_id: string, filters?: PayloadFilter): Promise<User[]> {
...
export async function search_rooms_for_user(user_id: string, filters?: PayloadFilter): Promise<Room[]> {
